...
if __name__ == "__main__":
    file_path = "/data/apps/data/crawler_yaml_system/datas/无忧考网"
    all_files = get_files_recursive(file_path)
    file_contents = [open(file).read() for file in all_files]
    dest_file = "/data/apps/data/crawler_yaml_system/无忧考网.jsonlines.txt"
    with open(dest_file, mode='a+', encoding='utf-8') as f:
